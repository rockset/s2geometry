...
//                         xbsl::make_unique<S2PolygonLayer>(&polygon),
//                         options);
//   S2Error error;
...
//       xbsl::make_unique<s2builderutil::PointVectorLayer>(&points),
//       xbsl::make_unique<s2builderutil::S2PolylineVectorLayer>(&polylines),
//       xbsl::make_unique<S2PolygonLayer>(&polygon));
