...
#include "s2/third_party/xbsl/base/casts.h"
#include "s2/third_party/xbsl/base/port.h"
#include "s2/third_party/xbsl/numeric/int128.h"
...
inline xbsl::uint128 gbswap_128(xbsl::uint128 host_int) {
  return xbsl::MakeUint128(gbswap_64(xbsl::Uint128Low64(host_int)),
                           gbswap_64(xbsl::Uint128High64(host_int)));
}
...
class LittleEndian {
 public:
  ...
  static xbsl::uint128 FromHost128(xbsl::uint128 x) { return x; }
  static xbsl::uint128 ToHost128(xbsl::uint128 x) { return x; }
  ...
  static xbsl::uint128 FromHost128(xbsl::uint128 x) { return gbswap_128(x); }
  static xbsl::uint128 ToHost128(xbsl::uint128 x) { return gbswap_128(x); }
  ...
  static xbsl::uint128 Load128(const void* p) {
    return xbsl::MakeUint128(
        ToHost64(UNALIGNED_LOAD64(reinterpret_cast<const uint64*>(p) + 1)),
        ToHost64(UNALIGNED_LOAD64(p)));
  }

  static void Store128(void* p, const xbsl::uint128 v) {
    UNALIGNED_STORE64(p, FromHost64(xbsl::Uint128Low64(v)));
    UNALIGNED_STORE64(reinterpret_cast<uint64*>(p) + 1,
                      FromHost64(xbsl::Uint128High64(v)));
  }
  ...
  // set all to 0.
  static xbsl::uint128 Load128VariableLength(const void* p, int len) {
    if (len <= 8) {
      return xbsl::uint128(Load64VariableLength(p, len));
    } else {
      return xbsl::MakeUint128(
...
class BigEndian {
 public:
  ...
  static void Store128(void* p, const xbsl::uint128 v) {
    UNALIGNED_STORE64(p, FromHost64(xbsl::Uint128High64(v)));
    UNALIGNED_STORE64(reinterpret_cast<uint64*>(p) + 1,
                      FromHost64(xbsl::Uint128Low64(v)));
  }
  ...
  static xbsl::uint128 Load128VariableLength(const void* p, int len) {
    if (len <= 8) {
      ...
      return xbsl::MakeUint128(Load64VariableLength(p, len - 8),
                               Load64(static_cast<const char*>(p) + len - 8));
    } else {
      return xbsl::MakeUint128(Load64(static_cast<const char*>(p)),
...
FROMHOST_TYPE_MAP(xbsl::uint128, xbsl::uint128);
...
class GeneralFormatConverter<EndianClass, float> {
 public:
  static typename tofromhost_value_type_traits<float>::int_type FromHost(
      float v) {
    return EndianClass::FromHost32(xbsl::bit_cast<uint32>(v));
  }
  static typename tofromhost_value_type_traits<float>::int_type ToHost(
      float v) {
    return xbsl::bit_cast<float>(
        EndianClass::ToHost32(xbsl::bit_cast<uint32>(v)));
  }
};
...
class GeneralFormatConverter<EndianClass, double> {
 public:
  static typename tofromhost_value_type_traits<double>::int_type FromHost(
      double v) {
    return EndianClass::FromHost64(xbsl::bit_cast<uint64>(v));
  }
  static typename tofromhost_value_type_traits<double>::int_type ToHost(
      double v) {
    return xbsl::bit_cast<double>(
        EndianClass::ToHost64(xbsl::bit_cast<uint64>(v)));
  }
};
...
template <class EndianClass>
class GeneralFormatConverter<EndianClass, xbsl::uint128> {
 public:
  static typename tofromhost_value_type_traits<xbsl::uint128>::int_type
  FromHost(xbsl::uint128 v) {
    return EndianClass::FromHost128(v);
  }
  static typename tofromhost_value_type_traits<xbsl::uint128>::int_type ToHost(
      xbsl::uint128 v) {
...
inline float LoadFloat(const char* p) {
  return xbsl::bit_cast<float>(EndianClass::ToHost32(UNALIGNED_LOAD32(p)));
}

template<typename EndianClass>
inline void StoreFloat(float value, char* p) {
  UNALIGNED_STORE32(p, EndianClass::FromHost32(xbsl::bit_cast<uint32>(value)));
}

template<typename EndianClass>
inline double LoadDouble(const char* p) {
  return xbsl::bit_cast<double>(EndianClass::ToHost64(UNALIGNED_LOAD64(p)));
}

template<typename EndianClass>
inline void StoreDouble(double value, char* p) {
  UNALIGNED_STORE64(p, EndianClass::FromHost64(xbsl::bit_cast<uint64>(value)));
}
...
template <>
inline xbsl::uint128 LittleEndian::Load<xbsl::uint128>(const char* p) {
  return LittleEndian::Load128(p);
}

template <>
inline void LittleEndian::Store<xbsl::uint128>(xbsl::uint128 value, char* p) {
  LittleEndian::Store128(p, value);
}

template <>
inline xbsl::uint128 BigEndian::Load<xbsl::uint128>(const char* p) {
  return BigEndian::Load128(p);
}

template <>
inline void BigEndian::Store<xbsl::uint128>(xbsl::uint128 value, char* p) {
