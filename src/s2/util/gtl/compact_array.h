...
class compact_array_base {
 ...
 public:                                // Sequence operations, table 67.
  ...
  void resize(size_type n) {
    ...
    if (n > size() &&
        !xbsl::is_trivially_default_constructible<value_type>::value) {
 ...
 private:                               // Helper functions for range/value.
  ...
  static_assert(xbsl::is_trivially_copy_constructible<value_type>::value &&
                xbsl::is_trivially_copy_assignable<value_type>::value &&
                xbsl::is_trivially_destructible<value_type>::value,
