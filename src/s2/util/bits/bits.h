...
class Bits {
 public:
  ...
  static inline int CountOnes128(xbsl::uint128 n) {
    return Bits::CountOnes64(xbsl::Uint128High64(n)) +
           Bits::CountOnes64(xbsl::Uint128Low64(n));
  }
  ...
  static inline int CountLeadingZeros128(xbsl::uint128 n) {
    if (uint64 hi = xbsl::Uint128High64(n))
      return Bits::CountLeadingZeros64(hi);
    return Bits::CountLeadingZeros64(xbsl::Uint128Low64(n)) + 64;
  }
  ...
  static xbsl::uint128 ReverseBits128(xbsl::uint128 n);
  ...
  static int Log2Floor128(xbsl::uint128 n);
  ...
  static int Log2FloorNonZero128(xbsl::uint128 n);

  // Return ceiling(log2(n)) for positive integer n.  Returns -1 iff n == 0.
  static int Log2Ceiling(uint32 n);
  static int Log2Ceiling64(uint64 n);
  static int Log2Ceiling128(xbsl::uint128 n);
  ...
  static int FindLSBSetNonZero128(xbsl::uint128 n);
  ...
  static int FindMSBSetNonZero128(xbsl::uint128 n) {
  ...
  static typename UnsignedType<T>::Type GetBits(const T src,
    ...
    const UnsignedT unsigned_src = xbsl::bit_cast<UnsignedT>(src);
  ...
  static void SetBits(const typename UnsignedType<T>::Type value,
                      ...
                      T* const dest) {
    typedef typename UnsignedType<T>::Type UnsignedT;
    const UnsignedT unsigned_dest = xbsl::bit_cast<UnsignedT>(*dest);
    S2_DCHECK_GT(sizeof(UnsignedT) * 8, offset);
    S2_DCHECK_GE(sizeof(UnsignedT) * 8, offset + nbits);
    ...
    *dest = xbsl::bit_cast<T>(unsigned_result);
  }
...
inline int Bits::Log2Floor128(xbsl::uint128 n) {
  if (uint64 hi = xbsl::Uint128High64(n)) return 64 + Log2FloorNonZero64(hi);
  return Log2Floor64(xbsl::Uint128Low64(n));
}

inline int Bits::Log2FloorNonZero128(xbsl::uint128 n) {
  if (uint64 hi = xbsl::Uint128High64(n)) return 64 + Log2FloorNonZero64(hi);
  return Log2FloorNonZero64(xbsl::Uint128Low64(n));
}

inline int Bits::FindLSBSetNonZero128(xbsl::uint128 n) {
  if (uint64 lo = xbsl::Uint128Low64(n)) return Bits::FindLSBSetNonZero64(lo);
  return 64 + Bits::FindLSBSetNonZero64(xbsl::Uint128High64(n));
}
...
inline xbsl::uint128 Bits::ReverseBits128(xbsl::uint128 n) {
  return xbsl::MakeUint128(ReverseBits64(xbsl::Uint128Low64(n)),
                           ReverseBits64(xbsl::Uint128High64(n)));
}
