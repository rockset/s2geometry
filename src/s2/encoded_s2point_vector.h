...
void EncodeS2PointVector(xbsl::Span<const S2Point> points, CodingHint hint,
                         Encoder* encoder);
...
class EncodedS2PointVector {
 ...
 private:
  friend void EncodeS2PointVector(xbsl::Span<const S2Point>, CodingHint,
                                  Encoder*);
  friend void EncodeS2PointVectorFast(xbsl::Span<const S2Point>, Encoder*);
  friend void EncodeS2PointVectorCompact(xbsl::Span<const S2Point>, Encoder*);
