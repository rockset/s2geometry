...
class S2CellId {
 public:
  ...
  static S2CellId FromDebugString(xbsl::string_view str);
 ...
 private:
  ...
  uint64 id_;
} XBSL_ATTRIBUTE_PACKED;  // Necessary so that structures containing S2CellId's
                          // can be XBSL_ATTRIBUTE_PACKED.
