...
//   layers[0] = xbsl::make_unique<IndexedS2PointVectorLayer>(index);
//   layers[1] = xbsl::make_unique<IndexedS2PolylineVectorLayer>(
//       index, polyline_options);
//   layers[2] = xbsl::make_unique<IndexedS2PolygonLayer>(index);
