...
#ifndef S2_THIRD_PARTY_XBSL_ALGORITHM_ALGORITHM_H_
#define S2_THIRD_PARTY_XBSL_ALGORITHM_ALGORITHM_H_
...
constexpr const T& clamp(const T& v, const T& lo, const T& hi) {
  return xbsl::clamp(v, lo, hi, algorithm_internal::Less{});
}
...
bool equal(InputIter1 first1, InputIter1 last1, InputIter2 first2,
           InputIter2 last2) {
  return xbsl::equal(first1, last1, first2, last2,
...
// `ForwardIterator` is not a random-access iterator, then `xbsl::rotate`
...
#endif  // S2_THIRD_PARTY_XBSL_ALGORITHM_ALGORITHM_H_
