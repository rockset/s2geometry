...
#ifndef S2_THIRD_PARTY_XBSL_STRINGS_INTERNAL_RESIZE_UNINITIALIZED_H_
#define S2_THIRD_PARTY_XBSL_STRINGS_INTERNAL_RESIZE_UNINITIALIZED_H_
...
#include "s2/third_party/xbsl/meta/type_traits.h"  //  for void_t
...
struct ResizeUninitializedTraits<
    string_type, xbsl::void_t<decltype(std::declval<string_type&>()
...
#endif  // S2_THIRD_PARTY_XBSL_STRINGS_INTERNAL_RESIZE_UNINITIALIZED_H_
