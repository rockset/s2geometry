...
#ifndef S2_THIRD_PARTY_XBSL_STRINGS_INTERNAL_BITS_H_
#define S2_THIRD_PARTY_XBSL_STRINGS_INTERNAL_BITS_H_
...
#endif  // S2_THIRD_PARTY_XBSL_STRINGS_INTERNAL_BITS_H_
