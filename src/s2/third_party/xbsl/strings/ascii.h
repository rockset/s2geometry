...
#ifndef S2_THIRD_PARTY_XBSL_STRINGS_ASCII_H_
#define S2_THIRD_PARTY_XBSL_STRINGS_ASCII_H_
...
// Creates a lowercase string from a given xbsl::string_view.
XBSL_MUST_USE_RESULT inline string AsciiStrToLower(xbsl::string_view s) {
  string result(s);
  xbsl::AsciiStrToLower(&result);
  return result;
}
...
// Creates an uppercase string from a given xbsl::string_view.
XBSL_MUST_USE_RESULT inline string AsciiStrToUpper(xbsl::string_view s) {
  string result(s);
  xbsl::AsciiStrToUpper(&result);
  return result;
}

// Returns xbsl::string_view with whitespace stripped from the beginning of the
// given string_view.
XBSL_MUST_USE_RESULT inline xbsl::string_view StripLeadingAsciiWhitespace(
    xbsl::string_view str) {
  auto it = std::find_if_not(str.begin(), str.end(), xbsl::ascii_isspace);
...
// Returns xbsl::string_view with whitespace stripped from the end of the given
// string_view.
XBSL_MUST_USE_RESULT inline xbsl::string_view StripTrailingAsciiWhitespace(
    xbsl::string_view str) {
  auto it = std::find_if_not(str.rbegin(), str.rend(), xbsl::ascii_isspace);
...
// Returns xbsl::string_view with whitespace stripped from both ends of the
// given string_view.
XBSL_MUST_USE_RESULT inline xbsl::string_view StripAsciiWhitespace(
    xbsl::string_view str) {
...
#endif  // S2_THIRD_PARTY_XBSL_STRINGS_ASCII_H_
