...
#ifndef S2_THIRD_PARTY_XBSL_NUMERIC_INT128_H_
#define S2_THIRD_PARTY_XBSL_NUMERIC_INT128_H_
...
// the `XBSL_HAVE_INTRINSIC_INT128` macro.)
//
...
// Example:
//
//     float y = xbsl::Uint128Max();  // Error. uint128 cannot be implicitly
//                                    // converted to float.
//
//     xbsl::uint128 v;
//     uint64_t i = v;                         // Error
...
class alignas(16) uint128 {
 public:
  ...
  // Example:
  //
  //   xbsl::uint128 big = xbsl::MakeUint128(1, 0);
 ...
 private:
  ...
  uint64_t lo_;
  uint64_t hi_;
#elif defined(XBSL_IS_BIG_ENDIAN)
  uint64_t hi_;
  uint64_t lo_;
#else  // byte order
...
#if defined(XBSL_HAVE_INTRINSIC_INT128)
#include "s2/third_party/xbsl/numeric/int128_have_intrinsic.inc"
#else  // XBSL_HAVE_INTRINSIC_INT128
#include "s2/third_party/xbsl/numeric/int128_no_intrinsic.inc"
#endif  // XBSL_HAVE_INTRINSIC_INT128
...
#endif  // S2_THIRD_PARTY_XBSL_NUMERIC_INT128_H_
