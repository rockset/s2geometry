...
#ifndef S2_THIRD_PARTY_XBSL_BASE_CASTS_H_
#define S2_THIRD_PARTY_XBSL_BASE_CASTS_H_
...
constexpr To implicit_cast(typename xbsl::internal::identity_t<To> to) {
  return to;
}
...
XBSL_DEPRECATED(
    "xbsl::bit_cast type requirements were violated. Update the types being "
...
#endif  // S2_THIRD_PARTY_XBSL_BASE_CASTS_H_
