...
//
// xbsl::base_internal::Invoke(f, args...) is an implementation of
...
#ifndef S2_THIRD_PARTY_XBSL_BASE_INTERNAL_INVOKE_H_
#define S2_THIRD_PARTY_XBSL_BASE_INTERNAL_INVOKE_H_
...
#endif  // S2_THIRD_PARTY_XBSL_BASE_INTERNAL_INVOKE_H_
