...
#ifndef S2_THIRD_PARTY_XBSL_BASE_PORT_H_
#define S2_THIRD_PARTY_XBSL_BASE_PORT_H_
...
#ifdef SWIG
%include "third_party/xbsl/base/attributes.h"
#endif
...
// resolve a dependency chain between util/hash/hash, xbsl/strings, and //base:
// in order for //base to depend on xbsl/strings, the includes of hash need
// to be in xbsl, not //base.  string_view defines hashes.
//
// -----------------------------------------------------------------------------
...
#endif  // S2_THIRD_PARTY_XBSL_BASE_PORT_H_
